...
import re
from long_context_llm.utils import calculate_metrics, parse_output, parse_rankings, calculate_retrieval_metrics
...
def truncate_llama2(dataset, data, postfix_text=" ... [the rest of the text is omitted]", max_length=None):
...
def load_train(dataset, shots=0, max_test_samples=None, seed=42, max_length=None):
    ...
    all_data = truncate_llama2(dataset, data, max_length=max_length)
...
def load_train_data(args, dataset, path=None, demo_path=None):
    data = load_train(dataset, args.shots, args.max_test_samples, seed=args.seed, max_length=args.input_max_length)
