...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default='4096',
        help="the maximum number of tokens of the input, we truncate from the left, can separate by comma to match the specified datasets"
    )
    parser.add_argument(
        "--num_clarification_rounds",
        type=int,
        default=1,
        help="number of self-clarification/context-grounding rounds before final answer"
    )
